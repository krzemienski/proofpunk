...
Called by: `codebase-truth-audit`, `completion-summary`, `full-functional-audit`, `implement`, `mobile-validation-runner`, `plan-hardening`, `production-readiness`, `red-team-eval`, `root-cause-debugging`, `tui-testing`, `ui-experience-audit`, `validation-plan`, `visual-inspection`, `proofpunk`.
