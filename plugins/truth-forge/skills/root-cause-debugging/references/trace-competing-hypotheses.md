> Incorporated from the `trace` skill (skills-ref.zip). **Adaptation:** Written for Claude Code team mode (parallel tracer agents); the hypothesis-competition discipline applies single-agent too — run the lanes sequentially.
