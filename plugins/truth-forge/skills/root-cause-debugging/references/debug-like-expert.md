...
See [expert-when-to-research.md](expert-when-to-research.md) for detailed guidance on research strategy.
...
See [expert-hypothesis-testing.md](expert-hypothesis-testing.md) for scientific method application.
...
See [expert-verification-patterns.md](expert-verification-patterns.md) for comprehensive verification approaches.
...
**Debugging mindset**: [expert-debugging-mindset.md](expert-debugging-mindset.md)
...
**Investigation techniques**: [expert-investigation-techniques.md](expert-investigation-techniques.md)
...
**Hypothesis testing**: [expert-hypothesis-testing.md](expert-hypothesis-testing.md)
...
**Verification patterns**: [expert-verification-patterns.md](expert-verification-patterns.md)
- Definition of "verified" (not just "it ran")
- Testing reproduction steps
- Regression testing adjacent functionality
- When to write tests before fixing

**Research strategy**: [expert-when-to-research.md](expert-when-to-research.md)
