...
```bash
# clone or unpack truth-forge-marketplace, then in Claude Code:
/plugin marketplace add /path/to/truth-forge-marketplace
...
```bash
tar -xzf truth-forge-marketplace.tar.gz
/plugin marketplace add ./truth-forge-marketplace
/plugin install truth-forge@truth-forge-marketplace
```
