...
| 3 | L1 | Unresolved repo-tree citations, resolved relative to citing file (citations) | 30 -> 29 (top-level: 1 -> 0) | 0 | **0 unresolved (top-level: 0) — PASS** | `evidence/v3-release/l1-citations/run-20260907T211217Z-verifier-mutation/step-03-restored.log@sha256:22f345cc9a4dcc5bc150e2af0d436179be26606cf034d1c4adb9dd1081ba3912` (measured value; sealed by `inventory.json@sha256:3736a3a5ad94f1125cb9e2bd326fb6a0cb80c25c035ac515326e0cdf6996b583`) |
| 4 | L16 | Commands proven end-to-end at the real slash-command surface: typed -> flag mapping -> real execution -> observed result, single artifact (commands) | 0/6 | 6/6 | **4/6 — UNMET** (2 capped at honest maximum: `verify`, `install` are playbook-recognition commands with no separate executable to drive; all 6 control arms failed as required) | `evidence/v3-release/l16-commands/command-surface-proof.json@sha256:8233e98327fe37c9440c7f69cbfd35db6d091680607c35273842cb24aba9fd0c` |
